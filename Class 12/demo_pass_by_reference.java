...
// pass by reference using object

import java.util.Scanner;
class demo_pass_by_reference
{
    int num1,num2;
    public static void main(String [] args)
    {
        ...
        demo_pass_by_reference obj1=new demo_pass_by_reference();
    ...
    public static void swap(demo_pass_by_reference obj2)
    {
        ...
        obj2.num1=obj2.num2;
        obj2.num2=temp;
        System.out.println("\tAfter swaping inside swap()method, num1 is "+obj2.num1+", num2 is "+obj2.num2);
    }
}